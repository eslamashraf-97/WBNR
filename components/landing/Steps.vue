...
const steps = [
  ...
  {
    title: "تسويق المنتج",
    desc: "سوّق منتجاتك بالطريقة اللي تريحك سواء فيسبوك، تيك توك أو سناب شات",
    image: Step2,
  },
  {
    title: "الشحن والتوصيل",
    desc: "شحن المنتجات لعملائك في جميع المناطق بأسعار منافسة",
    image: Step3,
  },
  {
    title: "تحصيل الأرباح",
    desc: "ارباحك هتوصلك من غير تأخير ولا مشاكل تحصيل فى اقل من دقائق",
    image: Step4,
  },
];
