...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white rounded-xl shadow-main py-9 px-16 flex justify-between" }, _ctx.$attrs, _attrs))}>`);
...
//# sourceMappingURL=filter-61cfcef4.mjs.map
