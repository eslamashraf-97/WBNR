...
import { useSSRContext, unref, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, Fragment, renderList, Transition } from 'vue';
      ...
      _push(ssrRenderComponent(unref(Menu), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div>`);
            _push2(ssrRenderComponent(unref(MenuItems), mergeProps({ class: "absolute left-0 z-10 mt-2 w-[257px] border border-gray-200 rounded-[12px] px-[32px] py-[28px] bg-gray-100" }, __props.menuProps), {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              ...
              createVNode(Transition, {
                ...
                default: withCtx(() => [
                  createVNode(unref(MenuItems), mergeProps({ class: "absolute left-0 z-10 mt-2 w-[257px] border border-gray-200 rounded-[12px] px-[32px] py-[28px] bg-gray-100" }, __props.menuProps), {
                    default: withCtx(() => [
                      createVNode("div", { class: "py-1" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(__props.items, (item, index) => {
                          return openBlock(), createBlock(unref(MenuItem), { key: index }, {
...
//# sourceMappingURL=menu-32072702.mjs.map
