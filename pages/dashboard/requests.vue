          ...
          <table class="w-full">
            ...
            <tbody>
              <tr v-for="(order, key) in data.data" :key="order.id" :ref="el => { divs[key] = el }">
                ...
                <td class="text-sm text-gray-700 font-normal flex justify-center items-center leading-normal cursor-pointer"
                    @click=toggleRow(key)
                >
                  <span class="bg-primary-100 text-primary-300 px-2 py-1 rounded-sm">تفاصيل الطلب</span>
                </td>
                  ...
                  <div class="my-8 px-6 max-h-72 overflow-auto">
                    ...
                    >
                      <div class="flex justify-between w-full items-center">
                        ...
                        <div class="px-2 py-1 bg-primary-100 text-primary-300 rounded">{{product.status_if_returned_before}}</div>
                        <button
