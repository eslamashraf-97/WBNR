...
const filteredData = data.value?.data
  ? route.query.id
    ? data.value.data.filter((item) => item.id == route.query.id)
    : data.value.data
  : [];
      ...
      <div class="p-4 mb-4">
        <div>
          <table class="w-full">
            ...
            <tbody>
              <tr
                v-for="(order, key) in filteredData"
                :key="order.id"
                :ref="
                  (el) => {
                    divs[key] = el;
              ...
              >
                ...
                <td
                  class="text-2xl text-gray-700 font-normal flex justify-center items-center leading-normal cursor-pointer"
                  @click="toggleRow(key)"
                >
                  <svg
                    :class="['rotate-180', { 'rotate-0': selected == key }]"
                  ...
                  >
                    <path
                      d="M20.8196 10.6718L11.0782 1.50042L1.02262 10.3263"
                      stroke="#76757A"
                      stroke-width="2"
                ...
                <td class="expanded-row-content hide-row px-4">
                  <div class="timeline flex justify-between relative">
                    <div class="bg-white z-30">
                      ...
                      <p
                        class="text-gray-400 text-xl font-semibold cursor-pointer"
                      >
                        لا يوجد تعليق
                      </p>
                    </div>
