...
import { u as apiGetSavedProductsUrl } from './index-f05587d3.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(pending) && ((_a = unref(productData)) == null ? void 0 : _a.data.length)) {
        _push(`<div class="mt-24 grid md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-9 grid-flow-row-dense"><!--[-->`);
...
//# sourceMappingURL=saved-products-5e918b64.mjs.map
