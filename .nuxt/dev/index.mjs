...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://D:/WBNR/WBNR/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/WBNR/WBNR/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/WBNR/WBNR/node_modules/devalue/index.js';
import { renderToString } from 'file://D:/WBNR/WBNR/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://D:/WBNR/WBNR/node_modules/@unhead/ssr/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://D:/WBNR/WBNR/node_modules/ufo/dist/index.mjs';
...
import { version, unref } from 'file://D:/WBNR/WBNR/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/WBNR/WBNR/node_modules/unhead/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\WBNR\\WBNR\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _dSrB0v3OHz = (function(nitro) {
...
const _lazy_l1wK5y = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_l1wK5y, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file://D:/WBNR/WBNR/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/WBNR/WBNR/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
