...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://D:/WBNR_new/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/WBNR_new/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/WBNR_new/node_modules/devalue/index.js';
import { renderToString } from 'file://D:/WBNR_new/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://D:/WBNR_new/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/WBNR_new/node_modules/ofetch/dist/node.mjs';
import destr from 'file://D:/WBNR_new/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://D:/WBNR_new/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/WBNR_new/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://D:/WBNR_new/node_modules/scule/dist/index.mjs';
import { klona } from 'file://D:/WBNR_new/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/WBNR_new/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://D:/WBNR_new/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://D:/WBNR_new/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/WBNR_new/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/WBNR_new/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/WBNR_new/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://D:/WBNR_new/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/WBNR_new/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/WBNR_new/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/WBNR_new/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\WBNR_new","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\WBNR_new\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\WBNR_new\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\WBNR_new\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\WBNR_new\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _3yee0jfPCf = (function(nitro) {
...
const _lazy_YWBCxQ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_YWBCxQ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_YWBCxQ, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/WBNR_new/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/WBNR_new/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
